...
app.secret_key ='trackyourexpense'

app.config['MYSQL_HOST'] = 'remotemysql.com'
app.config['MYSQL_USER'] = 'apn9dLUCEl'
app.config['MYSQL_PASSWORD'] = "81vr0HapJT"
app.config['MYSQL_DB'] = 'apn9dLUCEl'
            ...
            TEXT = """\
                    ...
                    <body>
                        <div class="containter" style="display: block;">
                            <span style="font-size: 48px;left: 20px;font-weight:bold; font-family:Arial, Helvetica, sans-serif; color:#7048a9;">Track Your Expense!</span>
